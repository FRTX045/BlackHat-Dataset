...
268,073 lines of Apache Combined access log, with a ground-truth
...
| Built | 2026-08-17T02:16:01.529316+00:00 |
| Wall clock | 796.394s |
...
`logforge/apache-shopfront-web@sha256:cd13e66d04f3d3aae721240ea2bb6730a93a168829e9029d75d213c040a709b2`.
...
- **2,548 distinct clients**, top-10 share
  0.2276, busiest made
  17,392 requests
- **56 distinct user agents**, top-1 share
  0.2009
- Referer present on 62.94%
...
760 seconds — the request *sequence* is
...
| | |
|---|---|
| Window | 2026-03-09T00:02:20.580286+00:00 → 2026-03-15T23:54:20.581295+00:00 |
| Span | 6.99 days |
| Days covered | 7 |
| Achieved rate | 0.4436 requests/second |
| Busiest second | 21 requests |
| Sessions | 7,833 (46 pushed later to keep one session per address at a time) |
...
| | |
|---|---|
| Attack lines sharing their exact second with ordinary traffic | 13.13% |
| Attack lines with ordinary traffic within ±30s | **68.09%** |
...
- Derived vs the log Apache wrote independently, on
  `access.raw.log`: **268049/268073 lines agreed; Apache's own log has 268073 lines; first divergence at line 2600**
- Unmatched request ids: **477**
...
- **Attack share is 6.55%.** The target is 2–8%.
- **Static assets are 76.18%
...
- **Single-request clients are
  1.81% of clients**, far below what the
