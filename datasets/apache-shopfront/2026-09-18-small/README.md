# apache-shopfront — small — 2026-09-18

64,751 lines of Apache Combined access log, with a ground-truth
...
| Built | 2026-09-18T08:07:16.899546+00:00 |
| Wall clock | 217.234s |
...
`logforge/apache-shopfront-web@sha256:6799dbbb233d306fef13ea8df5f6f3864eda078309a664428e149d94b4916be3`.
...
- **66 distinct user agents**, top-1 share
  0.226
- Referer present on 51.25%
  of non-asset requests
- Inter-arrival coefficient of variation
  4.6271

**616 of these requests came from a real Chromium**, driven
...
200 seconds — the request *sequence* is
...
| | |
|---|---|
| Window | 2026-03-09T00:00:48.713548+00:00 → 2026-03-10T00:00:56.657901+00:00 |
| Span | 1.00 days |
| Days covered | 2 |
| Achieved rate | 0.7494 requests/second |
| Busiest second | 651 requests |
| Sessions | 2,507 (31 pushed later to keep one session per address at a time) |
...
| | |
|---|---|
| Attack lines sharing their exact second with ordinary traffic | 19.85% |
| Attack lines with ordinary traffic within ±30s | **93.57%** |
...
- Derived vs the log Apache wrote independently, on
  `access.raw.log`: **64743/64751 lines agreed; Apache's own log has 64751 lines; first divergence at line 851**
- Unmatched request ids: **194**
...
- **Attack share is 6.39%.** The target is 2–8%.
- **Static assets are 69.25%
